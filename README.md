...
| 16 | 7/27 Mon | Graph engineering | Typed Graph Vault — private Markdown vault → validated typed graph; Mistral-grounded REPL and standalone traversal visualizer | Py | local | planned |
